...
<template>
  <footer class="bg-white">
    <div class="mx-auto max-w-screen-xl px-4 p-8">
      <div
        class="pt-4 border-t border-gray-100 flex flex-col justify-center sm:flex-row sm:items-center sm:justify-between gap-3"
      >
